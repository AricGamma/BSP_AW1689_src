...
#pragma alloc_text (PAGE, I2SEvtDeviceAdd)
#pragma alloc_text (PAGE, I2SEvtDriverContextCleanup)
#endif
...
--*/
{
	...
	Attributes.EvtCleanupCallback = I2SEvtDriverContextCleanup;

    WDF_DRIVER_CONFIG_INIT(&Config, I2SEvtDeviceAdd);
...
--*/
{
	...
	Status = I2SCreateDevice(pDeviceInit);
	if (!NT_SUCCESS(Status)) 
	{
...
void I2SEvtDriverContextCleanup(
