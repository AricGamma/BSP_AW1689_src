...
// Debug module name
#define STR_MODULENAME              "AudioAdapter: "

#define _Adapter_DbgPrintF(lvl, ...) \
{ \
    if (((lvl)==DEBUGLVL_BLAB) || (lvl < TRACE_LEVEL_INFORMATION)) {\
        DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, STR_MODULENAME);\
...
#define DPF                         _Adapter_DbgPrintF
#define DPF_ENTER(...)              DPF(D_FUNC, __VA_ARGS__)
