...
//        FILE_32_BYTE_ALIGNMENT,                     // 32 byte packet size alignment
...
ENDPOINT_MINIPAIR SpeakerMiniports =
{
    ...
    0,//ARRAYSIZE(SysvadWaveFilterInterfacePropertiesRender),   // Interface properties
    NULL,//SysvadWaveFilterInterfacePropertiesRender,
...
ENDPOINT_MINIPAIR MicArray1Miniports =
{
    ...
    0,//ARRAYSIZE(SysvadWaveFilterInterfacePropertiesCapture),  // Interface properties
    NULL,//SysvadWaveFilterInterfacePropertiesCapture,
