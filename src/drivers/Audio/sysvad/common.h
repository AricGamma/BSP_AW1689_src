...
DECLARE_INTERFACE_(IAdapterCommon, IUnknown)
{
	...
	STDMETHOD_(PI2S_FUNCTION_INTERFACE, GetI2sFunctionInterface)
	(
		THIS
	) PURE;

	STDMETHOD_(PCODEC_FUNCTION_INTERFACE, GetCodecFunctionInterface)
	(
		THIS
	) PURE;
	...
	STDMETHOD_(NTSTATUS, SetPowerDownCompletionCallback)
	(
		THIS_
	);

	STDMETHOD_(NTSTATUS, SetPowerState)
	(
		THIS_
