 ...
 ***************************************************************************
 */
static __u32 __USBC_PHY_REG_READ(ulong usbc_base_addr, __u32 usbc_phy_reg_addr)
{
  	__u32 reg_val = 0;
  	__u32 i = 0;
 ...
 ***************************************************************************
 */
static void __USBC_PHY_REG_WRITE(ulong usbc_base_addr, __u32 usbc_phy_reg_addr, __u32 usbc_phy_reg_data)
{
  	__u32 reg_val = 0;
 ...
 ***************************************************************************
 */
static void __USBC_PHY_SET_TX_AMPLITUDE(ulong usbc_base_addr, __u32 val)
{
 ...
 ***************************************************************************
 */
static void __USBC_PHY_SET_TX_SLEWRATE(ulong usbc_base_addr, __u32 val)
{
 ...
 */
/*
static void __USBC_PHY_SET_VBUS_VALID_THRESHOLD(ulong usbc_base_addr, __u32 val)
{
 ...
 */
/*
static void __USBC_PHY_OTG_FUNC_ENABLE(ulong usbc_base_addr, __u32 val)
{
 ...
 */
/*
static void __USBC_PHY_VBUS_DET_ENABLE(ulong usbc_base_addr, __u32 val)
{
 ...
 ***************************************************************************
 */
static void __USBC_PHY_SET_DISCON_DET_THRESHOLD(ulong usbc_base_addr, __u32 val)
{
...
static __u32 usb_phy0_write(__u32 addr, __u32 data, __u32 dmask, ulong usbc_base_addr)
{
	...
	USBC_Writeb((UCHAR)((dmask<<4)|data), usbc_base_addr + 0x404 + 2);
	USBC_Writeb((UCHAR)(addr|0x10), usbc_base_addr + 0x404);
	for(i=0;i<5;i++);
	USBC_Writeb((UCHAR)(addr|0x30), usbc_base_addr + 0x404);
	for(i=0;i<5;i++);
	USBC_Writeb((UCHAR)(addr|0x10), usbc_base_addr + 0x404);
	for(i=0;i<5;i++);
...
{
	UNREFERENCED_PARAMETER(hUSB);
	UNREFERENCED_PARAMETER(phy_index);
