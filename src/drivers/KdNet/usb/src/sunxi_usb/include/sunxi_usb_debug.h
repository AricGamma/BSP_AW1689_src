...
//#ifndef  CONFIG_USB_SUNXI_USB_DEBUG
//#define  CONFIG_USB_SUNXI_USB_DEBUG
//#endif

#ifdef  CONFIG_USB_SUNXI_USB_DEBUG

#define  DMSG_PRINT(fmt,...)		LOG_DBG(fmt,##__VA_ARGS__)
...
#define  DMSG_PRINT_EX(fmt,...)		LOG_ERR(fmt,##__VA_ARGS__)
