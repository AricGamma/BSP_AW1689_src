...
#ifdef WRITE_REGISTER_ULONG
#undef WRITE_REGISTER_ULONG
#endif
#define writel(y, x)		WRITE_REGISTER_ULONG((PULONG)x, y)

#ifdef WRITE_REGISTER_USHORT
#undef WRITE_REGISTER_USHORT
#endif
#define writew(y, x)		WRITE_REGISTER_USHORT((PUSHORT)x, y)

#ifdef WRITE_REGISTER_UCHAR
#undef WRITE_REGISTER_UCHAR
#endif
#define writeb(y, x)		WRITE_REGISTER_UCHAR((PUCHAR)x, y)

#ifdef READ_REGISTER_ULONG
#undef READ_REGISTER_ULONG
#endif
#define readl(x)		READ_REGISTER_ULONG((PULONG)x)

#ifdef READ_REGISTER_USHORT
#undef READ_REGISTER_USHORT
#endif
#define readw(x)		READ_REGISTER_USHORT((PUSHORT)x)

#ifdef READ_REGISTER_UCHAR
#undef READ_REGISTER_UCHAR
#endif
#define readb(x)		READ_REGISTER_UCHAR((PUCHAR)x)
