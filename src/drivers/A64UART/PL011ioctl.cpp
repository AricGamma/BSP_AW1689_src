    ...
    )
{
    ...
    *dtrRtsPtr = (regUARTCR & UART_RTS) != 0 ? SERIAL_RTS_STATE : 0;
    *dtrRtsPtr |= ((regUARTCR & UART_DTR) != 0 ? SERIAL_DTR_STATE : 0);
    ...
    )
{
    ...
    serialCommPropertiesPtr->SettableParams =
        ...
        SERIAL_SP_DATABITS  |
        SERIAL_SP_STOPBITS;
    if ((devExtPtr->UartSupportedControlsMask & (UART_FLOWCONTROL_En))
        != 0) {
    ...
    )
{
    ...
    //
    UARTIFLS_TXIFLSEL txFifoLevel = UARTIFLS_TXIFLSEL::TXIFLSEL_0;
    switch (fifoControl & SERIAL_TX_FIFO_MASK) 
	{

    case SERIAL_TX_1_BYTE_TRIG:
        txFifoLevel = UARTIFLS_TXIFLSEL::TXIFLSEL_0;
        break;

    case SERIAL_TX_4_BYTE_TRIG:
        txFifoLevel = UARTIFLS_TXIFLSEL::TXIFLSEL_1;
        break;

    case SERIAL_TX_8_BYTE_TRIG:
        txFifoLevel = UARTIFLS_TXIFLSEL::TXIFLSEL_2;
        break;

    case SERIAL_TX_14_BYTE_TRIG:
        txFifoLevel = UARTIFLS_TXIFLSEL::TXIFLSEL_3;
        break;
    ...
    //
    UARTIFLS_RXIFLSEL rxFifoLevel = UARTIFLS_RXIFLSEL::RXIFLSEL_3;
    switch (fifoControl & SERIAL_RX_FIFO_MASK) {

    case SERIAL_1_BYTE_HIGH_WATER:
        rxFifoLevel = UARTIFLS_RXIFLSEL::RXIFLSEL_0;
        break;

    case SERIAL_4_BYTE_HIGH_WATER:
        rxFifoLevel = UARTIFLS_RXIFLSEL::RXIFLSEL_1;
        break;

    case SERIAL_8_BYTE_HIGH_WATER:
        rxFifoLevel = UARTIFLS_RXIFLSEL::RXIFLSEL_2;
        break;

    case SERIAL_14_BYTE_HIGH_WATER:
        rxFifoLevel = UARTIFLS_RXIFLSEL::RXIFLSEL_3;
        break;
