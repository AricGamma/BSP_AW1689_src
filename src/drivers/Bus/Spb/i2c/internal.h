...
#define AW_I2C_OK      0
#define AW_I2C_FAIL   -1
#define AW_I2C_RETRY  -2
#define AW_I2C_SFAIL  -3  /* start fail */
#define AW_I2C_TFAIL  -4  /* stop  fail */
...
#define DPFLTR_I2C_INFO_LEVEL
#define DPFLTR_I2C_ERRO_LEVEL
#define DPFLTR_I2C_WARN_LEVEL
#define AWPRINT(string)					KdPrintEx((DPFLTR_IHVDRIVER_ID, DPFLTR_INFO_LEVEL, "I2C"##string##"\n"))
...
struct PBC_DEVICE 
{
    ...
    // register interface.
    PSUNXII2C_REGISTERS         pRegisters;
    ULONG                          RegistersCb;
